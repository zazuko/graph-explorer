    ...
    return (
      <div className={CLASS_NAME}>
        ...
        <div className={`${CLASS_NAME}__controls`}>
          ...
          <button
            className="ontodia-btn ontodia-btn-danger"
