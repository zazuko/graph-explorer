      ...
      <div>
        <div className="ontodia-default-template_body_expander">
          ...
          <div className="ontodia-default-template_body_expander_iri">
            <a
              className="ontodia-default-template_body_expander_iri__link"
              href={props.iri}
              title={props.iri}
            >
              {props.iri}
    ...
    return (
      ...
      >
        <div className="ontodia-default-template_type-line" title={props.label}>
          <div
            className="ontodia-default-template_type-line__icon"
            aria-hidden="true"
          >
          ...
          <div
            title={props.types}
            className="ontodia-default-template_type-line_text-container"
          >
        ...
        {image}
        <div
          className="ontodia-default-template_body"
          style={{ borderColor: props.color }}
        >
          <span
            className="ontodia-default-template_body__label"
            title={props.label}
          >
            {props.label}
          </span>
        ...
        <div className="ontodia-default-template_body_expander_property-table">
          {propsAsList.map((prop) => {
            ...
            return (
              <div
                key={prop.id}
                className="ontodia-default-template_body_expander_property-table_row"
              >
                <div
