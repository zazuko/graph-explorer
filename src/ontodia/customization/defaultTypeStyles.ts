...
const objectPropertyIcon = require<
  string
>('../../../images/icons/objectProperty.svg');
const datatypePropertyIcon = require<
  string
>('../../../images/icons/datatypeProperty.svg');
const personIcon = require<string>('../../../images/icons/person.svg');
const countryIcon = require<string>('../../../images/icons/country.svg');
const organizationIcon = require<
  string
