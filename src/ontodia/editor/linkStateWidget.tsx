...
export class LinkStateWidget extends React.Component<Props, {}> {
        ...
        if (statusText && title) {
          renderedState = (
            <span>
              ...
              [
              <span
                className={`${CLASS_NAME}__state-cancel`}
                onClick={onCancel}
                title={title}
              >
                cancel
  ...
  private renderLinkStateHighlighting() {
    ...
    return editor.model.links.map((link) => {
      ...
      const isDeletedLink = AuthoringState.isDeletedLink(
        editor.authoringState,
        link.data
      );
      const isUncertainLink = AuthoringState.isUncertainLink(
        editor.authoringState,
        link.data
      );
  ...
  render() {
    ...
    return (
      <div className={`${CLASS_NAME}`}>
        ...
        <div
          className={`${CLASS_NAME}__validation-layer`}
