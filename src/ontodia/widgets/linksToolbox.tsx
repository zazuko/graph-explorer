...
class LinkInToolBox extends React.Component<LinkInToolBoxProps, {}> {
  ...
  render() {
    ...
    const countIcon =
      this.props.count > 0 ? (
        <span className="ontodia-badge">{this.props.count}</span>
      ) : (
        ''
      );
    ...
    return (
      <li
        ...
        className="ontodia-list-group-item linkInToolBox clearfix"
      >
        <span
          className="ontodia-btn-group ontodia-btn-group-xs"
          data-toggle="buttons"
        >
          <label
            className={
