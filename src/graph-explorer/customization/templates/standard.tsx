...
export class StandardTemplate extends Component<TemplateProps, {}> {
  ...
  private renderTemplate(context: AuthoredEntityContext) {
    ...
    const isNewElement = AuthoringState.isNewElement(
    ...
    return (
      <div className={CLASS_NAME}>
        <div
          ...
          style={{ backgroundColor: leftStripeColor, borderColor: color }}
        >
          <div
          ...
          >
            ...
            {pinnedProperties ? (
              <div
                className={`${CLASS_NAME}__pinned-props`}
  ...
  private findPinnedProperties(
    context: AuthoredEntityContext
  ): PropArray | undefined {
