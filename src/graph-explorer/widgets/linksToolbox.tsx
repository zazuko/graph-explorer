...
class LinkTypesToolboxView extends React.Component<
  LinkTypesToolboxViewProps,
  { filterKey: string }
> {
  ...
  private getLinks = () => {
    ...
    return links
      .filter((linkType) => {
        ...
        return (
          !this.state.filterKey ||
          text.indexOf(this.state.filterKey.toLowerCase()) >= 0
        );
      })
      ...
      <div className={className}>
        <div className={`${className}__heading`}>
          ...
          <div className={`${className}__switch-all`}>
            <div className="graph-explorer-btn-group graph-explorer-btn-group-xs">
              <label
        ...
        <div className={`${className}__rest`}>
          {connectedTo}
          <div className="graph-explorer-scrollable">
            <ul className="graph-explorer-list-group connected-links">
              {views}
            </ul>
          </div>
        </div>
